...
from ...models.multi_document_response_tag_model import MultiDocumentResponseTagModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseTagModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseTagModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseTagModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseTagModel]
    """
