...
from ...models.multi_document_response_daily_sleep_model import MultiDocumentResponseDailySleepModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseDailySleepModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseDailySleepModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseDailySleepModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseDailySleepModel]
    """
