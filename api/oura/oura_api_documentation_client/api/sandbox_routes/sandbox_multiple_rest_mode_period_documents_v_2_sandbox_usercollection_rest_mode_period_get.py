...
from ...models.multi_document_response_rest_mode_period_model import MultiDocumentResponseRestModePeriodModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseRestModePeriodModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseRestModePeriodModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseRestModePeriodModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseRestModePeriodModel]
    """
