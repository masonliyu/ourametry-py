...
from ...models.multi_document_response_daily_readiness_model import MultiDocumentResponseDailyReadinessModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseDailyReadinessModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseDailyReadinessModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseDailyReadinessModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseDailyReadinessModel]
    """
