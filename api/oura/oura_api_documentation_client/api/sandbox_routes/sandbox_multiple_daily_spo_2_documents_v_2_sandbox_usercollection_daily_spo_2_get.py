...
from ...models.multi_document_response_daily_sp_o2_model import MultiDocumentResponseDailySpO2Model
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseDailySpO2Model]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseDailySpO2Model.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseDailySpO2Model]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseDailySpO2Model]
    """
