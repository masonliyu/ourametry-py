...
from ...models.multi_document_response_daily_resilience_model import MultiDocumentResponseDailyResilienceModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseDailyResilienceModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseDailyResilienceModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseDailyResilienceModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseDailyResilienceModel]
    """
