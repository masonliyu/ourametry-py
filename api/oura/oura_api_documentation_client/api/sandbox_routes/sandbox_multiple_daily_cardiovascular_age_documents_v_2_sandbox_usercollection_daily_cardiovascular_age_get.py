...
from ...models.multi_document_response_daily_cardiovascular_age_model import (
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseDailyCardiovascularAgeModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseDailyCardiovascularAgeModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseDailyCardiovascularAgeModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseDailyCardiovascularAgeModel]
    """
