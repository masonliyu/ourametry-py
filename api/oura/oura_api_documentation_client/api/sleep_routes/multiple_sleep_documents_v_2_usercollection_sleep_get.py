...
from ...models.multi_document_response_sleep_model import MultiDocumentResponseSleepModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseSleepModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseSleepModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseSleepModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseSleepModel]
    """
