...
from ...models.multi_document_response_sleep_time_model import MultiDocumentResponseSleepTimeModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseSleepTimeModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseSleepTimeModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseSleepTimeModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseSleepTimeModel]
    """
