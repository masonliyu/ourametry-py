...
from ...models.multi_document_response_daily_activity_model import MultiDocumentResponseDailyActivityModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseDailyActivityModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseDailyActivityModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseDailyActivityModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseDailyActivityModel]
    """
