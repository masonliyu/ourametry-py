...
from ...models.multi_document_response_session_model import MultiDocumentResponseSessionModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseSessionModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseSessionModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseSessionModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseSessionModel]
    """
