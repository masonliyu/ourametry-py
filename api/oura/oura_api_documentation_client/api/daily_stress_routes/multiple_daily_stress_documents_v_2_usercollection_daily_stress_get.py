...
from ...models.multi_document_response_daily_stress_model import MultiDocumentResponseDailyStressModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseDailyStressModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseDailyStressModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseDailyStressModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseDailyStressModel]
    """
