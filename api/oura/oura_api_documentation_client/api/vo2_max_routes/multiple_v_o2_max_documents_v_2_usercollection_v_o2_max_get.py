...
from ...models.multi_document_response_vo2_max_model import MultiDocumentResponseVO2MaxModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseVO2MaxModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseVO2MaxModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseVO2MaxModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseVO2MaxModel]
    """
