...
from ...models.multi_document_response_workout_model import MultiDocumentResponseWorkoutModel
...
) -> Optional[Union[Any, HTTPValidationError, MultiDocumentResponseWorkoutModel]]:
    if response.status_code == 200:
        response_200 = MultiDocumentResponseWorkoutModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MultiDocumentResponseWorkoutModel]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, MultiDocumentResponseWorkoutModel]
    """
